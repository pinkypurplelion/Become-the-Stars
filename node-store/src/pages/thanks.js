            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-8 offset-xl-2 page-body">
                        <p>
                            Thanks for choosing to name your star from Become the Stars. We hope that your experience with us has been beyond brilliant. You should shortly receive an email from Paypal with a receipt for your transaction. If you bought digital goods, you will receive an email from Become the Stars (digital@becomethestars.com) with your complete package within 24 hours of purchase. <br/> <br/>
                        </p>
                        <h1 class="package-heading text-center">Shipping Guidelines</h1> <hr/>
                        <p>
                            For our customers who have purchased packages including physical products, their progress can be tracked through our Order Tracker. All standard printing (certificates, posters, charts) is batch collected from our printing company on Friday each week. It will be posted on Saturday, and should hopefully arrive by Friday that week. <br/> <br/> 
